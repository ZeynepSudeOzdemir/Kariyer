...
namespace Admin.Controllers
{
    public class ResumesController : BaseController
    {
        ...
        {
            var resumeSet = db.ResumeSet.Include(r => r.User).Include(r => r.Category).Include(r => r.Comment).Include(r => r.Picture);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.CommentId = new SelectList(db.CommentSet, "Id", "Başlık");
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,Başlık,CategoryId,Text,CommentId,PictureId")] Resume resume)
        {
            ...
            ViewBag.CommentId = new SelectList(db.CommentSet, "Id", "Başlık", resume.CommentId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Başlık,CategoryId,Text,CommentId,PictureId")] Resume resume)
        {
            if (ModelState.IsValid)
            {
